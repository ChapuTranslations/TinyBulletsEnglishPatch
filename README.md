...
Simply give run permissions to patcher.py and execute. If everything's in order, it'll drop a patched .bin of the game in the bin folder and you'll be able to play it in English.

## Changelog:
###	v1.1:
*	Fixed a code bug that made defeating the second boss, the Undead Minion, much more difficult.
###	v1.0:
